...
public class MailCaseTestData {
    ...
    static final List<MailCase> MAIL_CASES = ImmutableList.of(
            ...
            new MailCase("toMail2@ya.ru", null, "subject2", "state2", Date.from(now.minus(Duration.ofMinutes(1)))),
            new MailCase(null, "ccMail3@ya.ru", "subject3", "state3", DATE_FROM)
    );

    private static final MailCase MAIL_CASE_EXCLUDED = new MailCase(
            "toMail4@ya.ru", "ccMail4@ya.ru", "subject4", "state4",
