<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:p="http://javaops.ru"
            ...
            <body>
                ...
                <table border="1" cellpadding="8" cellspacing="0">
                    ...
                    <xsl:for-each select="/p:Payload/p:Projects/p:Project[@name=$projectName]/p:Group">
                        <tr>
                            <td><sxl:value-of select="@name"/></td>
                            <td><sxl:value-of select="@type"/></td>
                        </tr>
                    </xsl:for-each>
                </table>
            </body>
